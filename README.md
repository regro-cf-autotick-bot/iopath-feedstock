...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/iopath-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13270&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iopath-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `iopath` can be installed with:

```
conda install iopath
```

It is possible to list all of the versions of `iopath` available on your platform with:
